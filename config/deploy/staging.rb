...
set :domain,     '120.79.183.89'
set :deploy_to,  '/data/project'
set :repository, 'git@github.com:ShowLew/graduation_peoject.git'
set :branch,     'master'
set :user,       'root'
set :identity_file, '/home/showlew/Downloads/showlew.pem'
set :rails_env,  'staging'

# nginx.conf.erb
set :server_name,   '120.79.183.89'
